...
export default () => (
	<Layout>
		...
		<div className="lh-copy f4 serif mw8 center">
			<p>
				Gatsby Starter Yanna Resse ("us", "we", or "our") operates the
			...
			<p>
				Gatsby Starter Yanna Resse uses the collected data for various purposes:
			</p>
			<ul>
			...
			<p>
				Gatsby Starter Yanna Resse will take all steps reasonably necessary to
			...
			<p>
				Gatsby Starter Yanna Resse may disclose your Personal Data in the good
				faith belief that such action is necessary to:
			</p>
			<ul>
				<li>To comply with a legal obligation</li>
				<li>
					To protect and defend the rights or property of Gatsby Starter Yanna
					Resse
				</li>
				<li>
